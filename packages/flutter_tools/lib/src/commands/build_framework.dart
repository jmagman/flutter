...
class BuildFrameworkCommand extends BuildSubCommand {
  BuildFrameworkCommand({this.targetPlatform}) {
    usesTargetOption();
    usesPubOption();
    argParser
      ..addFlag('debug',
        negatable: true,
        defaultsTo: true,
        help: 'Produce debug frameworks'
      )
      ..addFlag('profile',
        negatable: true,
        defaultsTo: true,
        help: 'Produce profile frameworks'
      )
      ..addFlag('release',
        negatable: true,
        defaultsTo: true,
        help: 'Produce release frameworks'
      )
      ..addFlag('universal',
  ...
  @override
  final String name = 'frameworks';

  @override
  final List<String> aliases = <String>['framework'];
